                  ...
                  <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-12 ">
                        <input type="password" class="form-control input-lg" id="password" name="password" value="{{ old('password') }}" placeholder="Password" required>
                      </div>
                      <div class="form-group col-md-12 ">
                        <input type="password" class="form-control input-lg"  id=" name="password_confirmation" name=" name="password_confirmation placeholder="Confirm Password" required>
                      </div>
                      {{-- <div class="col-md-12">
