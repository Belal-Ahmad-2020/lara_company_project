            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="{{ route('login') }}">
                  ...
                  <span class="brand-name text-center">Company</span>
                </a>
              </div>
            </div>
              ...
              <form action="{{ route('login') }}" method="POST">
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="email" name="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Email Address" autofocus required 
                    value="{{ old('email') }}">
                  </div>
